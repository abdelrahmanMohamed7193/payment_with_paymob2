...
FirstTokenModel firstTokenModelFromJson(String str) => FirstTokenModel.fromJson(json.decode(str));

String firstTokenModelToJson(FirstTokenModel data) => json.encode(data.toJson());
